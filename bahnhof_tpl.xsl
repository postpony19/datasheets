			...
			<td colspan="{$maxcols}" class="mitte">
				<table border="1" style="margin: 0 auto;">
					<tr>
						...
						<td colspan="2"><xsl:text disable-output-escaping="yes">{{{CARSQUANTITY}}}</xsl:text></td>
						<td rowspan="5"><xsl:text disable-output-escaping="yes">&#160;&#160;&#160;</xsl:text></td>
						<td colspan="2"><xsl:text disable-output-escaping="yes">{{{PARCELCARSQUANTITY}}}</xsl:text></td>
						<td rowspan="5"><xsl:text disable-output-escaping="yes">&#160;&#160;&#160;</xsl:text></td>
						<td colspan="2"><xsl:text disable-output-escaping="yes">{{{EXPRESSCARSQUANTITY}}}</xsl:text></td>
					</tr>
					<tr>
						<td><xsl:text disable-output-escaping="yes">{{{PERDAY}}}</xsl:text></td>
						<td><xsl:text disable-output-escaping="yes">{{{PERWEEK}}}</xsl:text></td>
						<td><xsl:text disable-output-escaping="yes">{{{PERDAY}}}</xsl:text></td>
						<td><xsl:text disable-output-escaping="yes">{{{PERWEEK}}}</xsl:text></td>
						<td><xsl:text disable-output-escaping="yes">{{{PERDAY}}}</xsl:text></td>
						<td><xsl:text disable-output-escaping="yes">{{{PERWEEK}}}</xsl:text></td>
					...
					<tr>
						<td style="text-align:right;"><xsl:text>{{{RECEIVING}}}</xsl:text></td>
					...
					<tr>
						<td style="text-align:right;"><xsl:text>{{{DISTRIBUTION}}}</xsl:text></td>
					...
					<tr style="font-weight:bold;">
						<td style="text-align:right;"><xsl:text>{{{TOTAL}}}</xsl:text></td>
